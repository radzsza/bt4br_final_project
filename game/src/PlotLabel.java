...
public class PlotLabel extends JLabel {
    ...
    public PlotLabel(String theme, String colorPalette, int plotNumber) {
        ...
        setIcon(new ImageIcon(getClass().getResource("img/plot_images/" + theme + plotNumber + ".png")));
    ...
    public void paintComponent(Graphics g) {
        g.drawImage(new ImageIcon(getClass().getResource("img/plot_images/" + colorPalette + ".png")).getImage(), 0, 0, getWidth(), getHeight(), this);
